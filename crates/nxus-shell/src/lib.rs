//! `nxus` Command-line interface shell.
//!
//! This crate owns CLI argument parsing, command dispatch and terminal-facing output,
...
/// `nxus` CLI parser and arg/command models.
pub mod cli;
/// `nxus` CLI commands.
